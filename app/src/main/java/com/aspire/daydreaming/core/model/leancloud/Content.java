package com.aspire.daydreaming.core.model.leancloud;

import com.aspire.daydreaming.core.model.info.ActivityInfo;
import com.aspire.daydreaming.core.model.info.ActivityMember;
import com.aspire.daydreaming.core.model.info.ImageItem;
import com.aspire.daydreaming.core.model.info.MessageModel;
import com.aspire.daydreaming.core.model.info.SchoolMateInvitation;
import com.aspire.daydreaming.core.model.info.SchoolMateModel;
import com.aspire.daydreaming.core.model.info.SearchUserModel;
...
public class Content {
    ...
    public _User getUserModel() {
        return user;
    }

    public void setUserModel(_User users) {
        this.user = users;
    }
    ...
    public List<ActivityInfo> getActivityModels() {
        return activityModels;
    }

    public void setActivityModels(List<ActivityInfo> activityModels) {
